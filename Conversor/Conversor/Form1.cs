...
namespace Conversor
{
    public partial class Form1 : Form
    {
        ...
        // Método vacío para eliminar el error CS0103 del Designer
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Ingrese una cantidad numérica válida.", "Atención", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }

            if (comboBox1.SelectedItem == null || comboBox2.SelectedItem == null || comboBox3.SelectedItem == null)
            {
                MessageBox.Show("Seleccione la categoría y ambas unidades.", "Atención", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            label2.Text = $"Resultado: {cantidad} {unidadDe} = {resultado:G8} {unidadA}";
        }
    }
}